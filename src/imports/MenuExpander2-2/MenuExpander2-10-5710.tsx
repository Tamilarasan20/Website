import svgPaths from "./svg-dswynu1q0l";
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[2px] items-center px-[8px] py-[12px] relative size-full">
          ...
          <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Chevron Up">
            <div className="absolute flex inset-[51.08%_-17.68%_1.07%_34.46%] items-center justify-center" style={{ containerType: "size" }}>
...
export default function MenuExpander() {
  return (
    <div className="bg-[#f3f6fb] content-stretch flex flex-col gap-[16px] items-start px-[16px] py-[20px] relative rounded-[20px] shadow-[0px_36.858px_13.981px_0px_rgba(227,233,254,0.02),0px_2.542px_5.084px_0px_rgba(186,201,250,0.15)] size-full" data-name="Menu Expander 2">
      <Frame />
      <Frame7 />
      <Frame8 />
    </div>
